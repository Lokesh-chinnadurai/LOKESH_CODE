...
# Load the YOLO model
model = YOLO('loaded_bag.pt')  # Replace with your model path

# Open the video file
video_path = 'D:\vChanel\truck\truck_bag_1.avi'  # Replace with your video path
...
output_path = 'truck_bag_1.mp4'
fourcc = cv2.VideoWriter_fourcc(*'mp4v')
out = cv2.VideoWriter(output_path, fourcc, fps, (width, height))

# Define the zone coordinates
zone = [(1450, 425), (1450, 700), (1650, 700), (1650, 425)]
...
while cap.isOpened():
    ...
    # Display the count
    cv2.putText(frame, f"Count: {object_count}", (100, 100), cv2.FONT_HERSHEY_SIMPLEX, 3, (0, 255, 255), 2)
